                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('user.update', $user->id) }}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="text" name="username" placeholder="Username" value="{{ $user->username }}" required="" readonly="" style="background:silver;">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="active">
                                    ...
                                    <option {{ !$user->active ? 'selected' : '' }} value="0">In-active</option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10">
                                <select name="module[]" class="select2 form-control select2-multiple" multiple="multiple" data-placeholder="Modul">
                                    @foreach ($modules as $module)
                                        <option {{ \Str::contains($user->module, $module->module) ? 'selected' : '' }} value="{{ $module->module }}">{{ $module->module }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
