            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="p-3">
                        ...
                        <form class="form-horizontal m-t-10" action="{{ route('user.authafterotp') }}" method="post">
							@method('post')
							@csrf
                            ...
                            <div class="card bg-success">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="otp" placeholder="Enter One Time Password" required  autofocus="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="display: none"> 
                                <div class="form-group">
                                  <label for="username">loginAuth</label>
                                  <input type="hidden" class="form-control" name="loginAuth" value="{{ $loginAuth }}" placeholder="Enter username" required="" >
                              </div>
                                <div class="form-group">
                                    <label for="username">Username</label>
                                    <input type="hidden" class="form-control" name="username" value="{{ $username }}" placeholder="Enter username" required="" >
                                </div>
                                ...
                                <div style="display: none"> 
                                    <div class="col-sm-6">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="agree" value="true" class="custom-control-input" id="customControlInline" checked>
